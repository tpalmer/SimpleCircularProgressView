...
- (void)awakeFromNib {
    ...
    self.correctLabel.textColor = [self blueColor:1];
...
- (void)renderCircularView
{
    ...
    int padding = [Util isRetina] ? (kPadding * 2) : kPadding;
    ...
    circle.path = [Util circlePathWithStartAngle:start_angle
                                       end_angle:end_angle
                                           width:width
                                          height:height
    ...
    circle.strokeColor = [Util blueColor:1].CGColor;
    circle.lineCap = kCALineCapRound;
    circle.lineWidth = line_width;
    underCircle.fillColor = [UIColor clearColor].CGColor;
    underCircle.strokeColor = [Util backgroundColor].CGColor;
